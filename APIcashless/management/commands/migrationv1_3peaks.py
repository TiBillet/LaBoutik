...
class Command(BaseCommand):
    def handle(self, *args, **options):
        self.migration3Peaks()

    def migration3Peaks(self):
        with open('data/3Peaks_Cashless-2020-04-30-23-45.json') as datafile:
        ...
        for entry in data:
            if entry['model'] == "APIcashless.membres":
                ...
                print(membre['name'])
            #
            # if entry['model'] == "APIcashless.pagearticle":
            #     page = entry['fields']
            #     if "PeakSu" in page['name']:
