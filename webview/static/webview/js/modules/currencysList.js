...
// cc=MAD =>  htmlContent: '&#x62f;&#x2e;&#x625;' // supprimer cette propriété pour retouter "symbol"
const currencysList = [
 ...
 * @param {String} cc - code monnaie du pays sélectionné
 * @returns {currencyObject}
 */
export function getCurrentCurrency(cc) {
  return currencysList.find(item => item.cc === cc)
}